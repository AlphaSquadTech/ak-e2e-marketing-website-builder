#!/usr/bin/env bash
# Initialize a NextJS project optimized for marketing websites with SEO.
#
...
# - Marketing site folder structure
...
echo "==> Creating marketing site directory structure"
...
mkdir -p public/og/placeholders
mkdir -p screenshots
